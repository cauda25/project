...
// @Query("SELECT u FROM UserEntity u WHERE u.lastLogin < :lastTime AND
// u.statusRole = :statusRole")
// List<UserEntity> findInactiveUsers(LocalDateTime lastTime, StatusRole
// statusRole);
